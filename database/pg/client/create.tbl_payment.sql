...
COMMENT ON COLUMN tbl_payment_test.check_from IS 'Required for 3rd-party checks';

CREATE VIEW payment_test AS SELECT * FROM tbl_payment_test WHERE NOT is_deleted;

CREATE INDEX index_tbl_payment_test_client_id ON tbl_payment_test ( client_id );
CREATE INDEX index_tbl_payment_test_client_id_payment_date ON tbl_payment_test ( client_id,payment_date );
CREATE INDEX index_tbl_payment_test_payment_date_client_id ON tbl_payment_test ( payment_date,client_id );
CREATE INDEX index_tbl_payment_test_payment_date ON tbl_payment_test ( payment_date );
