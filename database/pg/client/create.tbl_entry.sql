CREATE TABLE tbl_entry (
	...
	issue_no			INTEGER,
	source			CHAR(1),
	scanner_location_code	VARCHAR(10) NOT NULL REFERENCES tbl_l_scanner_location(scanner_location_code),
	--system fields
...
CREATE INDEX index_tbl_entry_scanner_location_code ON tbl_entry ( scanner_location_code ) WHERE NOT is_deleted;
